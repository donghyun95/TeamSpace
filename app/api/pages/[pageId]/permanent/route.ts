...
import { permanentlyDeletePageWithDescendants } from '@/server/page/queries';
...
export async function DELETE(req: Request, { params }: RouteContext) {
  try {
    ...
    const result = await permanentlyDeletePageWithDescendants(parsedPageId, userId);
    ...
    console.error('DELETE /api/pages/[pageId]/permanent error:', error);
